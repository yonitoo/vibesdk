...
const OPENROUTER_AGENT_CONFIG: AgentConfig = {
    ...COMMON_AGENT_CONFIGS,
    templateSelection: {
        name: AIModels.OR_GEMINI_2_5_FLASH_LITE,
        max_tokens: 2000,
        fallbackModel: AIModels.OR_GEMINI_2_5_FLASH,
        temperature: 0.6,
    },
    blueprint: {
        name: AIModels.OR_GEMINI_2_5_FLASH,
        reasoning_effort: 'high',
        max_tokens: 64000,
        fallbackModel: AIModels.OR_GEMINI_2_5_PRO,
        temperature: 1,
    },
    projectSetup: {
        name: AIModels.OR_GEMINI_2_5_FLASH,
